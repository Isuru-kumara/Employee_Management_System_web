...
?>
    ...
    <body style="background: #ECDAED;">
        <nav class="navbar navbar-inverse navbar-fixed-top" style="background-color: #db86e2;border: 0;" role="navigation">
        ...
        <div class="col-md-10"></div>
            ...
            <div class="col-md-10 colors text-center">
                ...
                <div class="col-md-10 colors-div">
                    <label class="color-scheme-text">Event Categories</label><br>
