...
import { faArrowRightFromBracket, faMessage, faCalendarDays, faCalendarDay, faCalendarCheck, faCircleUser, faBoxArchive, faHouse, faPieChart, faRectangleList } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div className='sidebar mx-3'>
      <Stack gap={2} className='justify-content-center px-5 py-3'>
          ...
          <Nav.Link href="./pages/Home"><div className="rowCard"><FontAwesomeIcon icon={faArrowRightFromBracket} className="px-2"/><hr/>Logout</div></Nav.Link>
      </Stack>       
    </div>    
  )
}
